...
public class MenuUtil {
	...
	public FoodCategory addFoodCategory() {
		...
		System.out.println("This is food  category list choose if food belongs to group : choose : (yes/no)");
		categoryChoice = sc.next().toLowerCase();
		if(categoryChoice.equals("yes")) {
			System.out.println("chose Food Category id as above");
			Long categoryId = sc.nextLong();
			return foodCategoryServiceImpl.getFoodCategoryById(categoryId);
		}else {
			System.out.println("-----------Add food category-------------------");
